...
const DISTROS = [
  ...
  { id: "resolute",        label: "Ubuntu 26.04 (Resolute)", family: "apt" },
  { id: "trixie",          label: "Debian 13 (Trixie)",      family: "apt" },
  { id: "bookworm",        label: "Debian 12 (Bookworm)",    family: "apt" },
  { id: "bullseye",        label: "Debian 11 (Bullseye)",    family: "apt" },
  // RPM — DNF (RHEL family)
  { id: "almalinux10",     label: "AlmaLinux 10",            family: "dnf" },
  { id: "almalinux9",      label: "AlmaLinux 9",             family: "dnf" },
  { id: "almalinux8",      label: "AlmaLinux 8",             family: "dnf" },
  { id: "rocky10",         label: "Rocky Linux 10",          family: "dnf" },
  { id: "rocky9",          label: "Rocky Linux 9",           family: "dnf" },
  { id: "rocky8",          label: "Rocky Linux 8",           family: "dnf" },
  { id: "centos-stream10", label: "CentOS Stream 10",        family: "dnf" },
  { id: "centos-stream9",  label: "CentOS Stream 9",         family: "dnf" },
  { id: "oraclelinux10",   label: "Oracle Linux 10",         family: "dnf" },
  { id: "oraclelinux9",    label: "Oracle Linux 9",          family: "dnf" },
  { id: "oraclelinux8",    label: "Oracle Linux 8",          family: "dnf" },
  { id: "fedora44",        label: "Fedora 44",               family: "dnf" },
  { id: "fedora43",        label: "Fedora 43",               family: "dnf" },
  { id: "fedora",          label: "Fedora 42 (EOL)",         family: "dnf" },
  // RPM — Zypper (openSUSE)
  { id: "opensuse-leap-16.0",   label: "openSUSE Leap 16.0",    family: "zypper" },
  ...
  // APK — Alpine Linux
  { id: "alpine3.24", label: "Alpine Linux 3.24", family: "apk" },
  { id: "alpine3.23", label: "Alpine Linux 3.23", family: "apk" },
  { id: "alpine3.22", label: "Alpine Linux 3.22", family: "apk" },
